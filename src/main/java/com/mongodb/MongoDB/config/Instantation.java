...
public class Instantation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("24/03/2025"), "Partiu viagem!", "Estou indo viajar", maria);
        Post post2 = new Post(null, sdf.parse("25/03/2025"), "Um belo dia", "Dia de chuva!", maria);
